...
public interface RoomService {
	 ...
	 * @param roomNoArr 
	 */
	List<Room> searchRooms(int mbrNo, List<Integer> roomNoList, double startLat, double startLng, int startRange, double endLat, double endLng, int endRange) throws Exception;
